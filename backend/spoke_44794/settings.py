"""
Django settings for spoke_44794 project.
...
WSGI_APPLICATION = 'spoke_44794.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "spoke_44794 API",
    "DESCRIPTION": "API documentation for spoke_44794 App",
    "VERSION": "v1",
}
